...
```{r}
df = read.csv("/Users/jack/Desktop/447/amazon_review_polarity_csv/train.csv", header = FALSE)
```

```{r}
reviews_text<-readLines("/Users/jack/Desktop/447/amazon_review_polarity_csv/train.csv", n = 1000)
