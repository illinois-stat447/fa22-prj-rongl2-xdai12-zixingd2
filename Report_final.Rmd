...
Again, we used the training data from the first split. Since dtm_train is a large sparse matrix, we used commands from the R package \verb|slam| to efficiently compute the mean and var for each column of dtm_train.
```{r}
